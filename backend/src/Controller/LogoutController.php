...
{
    public function __construct(private readonly JwtRevocationStore $jwtRevocationStore)
    {
    }
    ...
    public function __invoke(Request $request): JsonResponse
    {
        ...
        if (!\is_string($tokenId) || '' === $tokenId || !\is_int($expiresAt)) {
            return new JsonResponse(['message' => 'Token invalide.'], JsonResponse::HTTP_BAD_REQUEST);
        }
